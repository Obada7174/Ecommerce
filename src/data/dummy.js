...
export const EditorData = () => (
  <div>
    <h3>
      ...
      adoption, and you can use as little or as much React as you need. Whether
      you want to get a taste of React, add some interactivity to a simple HTML
      ...
      demos. Add React to a Website You can add React to an HTML page in one
      minute. You can then either gradually expand its presence, or keep it
...
export const links = [
...

  {
    ...
    links: [
      ...
      {
        name: "Add User",
        icon: <TiUserAddOutline className="text-[22px]" />,
        url: "adduser",
        roleShow: ["1995"],
      },
      {
      ...
      {
        name: "Add Product",
        icon: <MdOutlineAddBusiness className="text-xl" />,
        roleShow: ["1999", "1995"],
        url: "addproduct",
      },
...
export const FooterData = [
  {
    ...
    links: [
      { name: "FAQ's", url: "faqs" },
      { name: "Ordering Tracking", url: "orderingtracking" },
  ...
  },
  {
    ...
    links: [
      { name: "Delivery Information", url: "faqs" },
      { name: "Discount", url: "faqs" },
      { name: "Payment & Shipping", url: "contacts" },
      { name: "Estimated Delivery Time", url: "events" },
      { name: "Shipping Guide", url: "helpcenter" },
    ],
  },
  {
    title: "Information",
